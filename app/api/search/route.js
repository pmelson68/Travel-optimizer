...
departure: flight.route?.[0]?.dTime ? new Date(flight.route[0].dTime * 1000).toLocaleTimeString() : 'N/A',
arrival: flight.route?.[flight.route.length - 1]?.aTime ? new Date(flight.route[flight.route.length - 1].aTime * 1000).toLocaleTimeString() : 'N/A',
